...
async function binarySearchStep3() {
    ...
    // Conservative estimate (assumes 4.5s per book, actual usually ~3.5s)
    const estimatedMinutes = Math.ceil((TEST_RANGE.totalBooks * (DELAY_MS + 1500)) / 1000 / 60);
    console.log(`   Conservative estimate: ~${estimatedMinutes} minutes`);
    console.log(`   Actual usually: ~${Math.ceil(TEST_RANGE.totalBooks * 3.5 / 60)} minutes`);
    console.log('');
...
console.log('========================================');
console.log('');
console.log('This script tests if range [2161, 2321] causes Cats to fail.');
console.log('');
...
console.log('   Conservative: ~10 minutes');
console.log('   Actual usually: ~9 minutes');
console.log('');
console.log('========================================');
console.log('');

...
- [ ] **Freshness banner: show BOTH times** (Ron, 2026-09-01, first real-world firing) — "Your library is from 3:04 PM — a newer one from 5:04 PM is available. Tap to refresh." Both numbers already in hand (cache savedAt + pointer gen's embedded time); pure copy change in mobile's banner. Ship with toast history (7.6.1).

...
- [ ] Fetcher follow-ups: ownership-**upgrade** live positive test; un-trash on ownership upgrade (storage.js); fix the "772%" enriched ratio; elapsed-time display frozen during "Checking pending additions" / "Recovering" phases (timer repaints only on phase/progress updates — Ron 2026-09-03)
